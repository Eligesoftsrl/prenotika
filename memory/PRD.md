...
- **P1**: refactor `server.py` (~1700 righe) in router modulari `/app/backend/routes/*`
...
- **P3**: signup tenant self-service + **Stripe** subscriptions (piani Pro/Business automatici)
